...
export default function Format() {
    ...
    return(
        <main>
            ...
            <img className='readings-img' src='format.png' alt='meeting format' />
            </div>
            <div className="readings-container">
                <p className="readings-font"><strong>Welcome</strong><br></br><br></br> 
                    ...
                    God, grant us the serenity to accept the things we cannot change, courage to change the things we can, and wisdom to know the difference.<br></br><br></br>
                    <strong>AA Preamble</strong><br></br><br></br>
                    Alcoholics Anonymous is a fellowship of people who share their experience, strength and hope with each other that they may solve their common problem and help others to recover from alcoholism.<br></br><br></br> 
                    The only requirement for membership is a desire to stop drinking. There are no dues or fees for A.A. membership; we are self- supporting through our own contributions.<br></br><br></br>A.A. is not allied with any sect, denomination, politics, organization or institution; does not wish to engage in any controversy, neither endorses nor opposes any causes. Our primary purpose is to stay sober and help other alcoholics to achieve sobriety.<br></br><br></br> 
                    I have asked ***** to read a portion of the Big Book:<br></br>
                    How it Works pg. 58<br></br>
                    ...
                    Do we have anyone celebrating monthly milestones this week? 
                    <br></br><br></br>
                    Any yearly birthdays for the month of ******? 
                    <br></br><br></br>
                    <strong>Tools</strong> 
                    <br></br><br></br>
                    ...
                    <br></br><br></br>
                    We have come to the bottom of our sharing hour; I would like to take this time to ask if anyone has a burning desire. If you are struggling with your sobriety and feel you need to share, share now with the group.
                    <br></br><br></br>
                    The meeting also stays open for the meeting after the meeting for fellowship.
                    <br></br><br></br>
                   ...
                   <br></br><br></br>
                    ...
                    <br></br>
                    Our global Sponsor phone list is http://zoomintoaa.com/phonelist/ 
                    <br></br><br></br> 
                    Are there any other AA or Non-AA announcements? <br></br><br></br>
                    Congratulations to everyone that's celebrating today<br></br><br></br>
                    I would also like to thank our Readers.  
                    Now I would like to close with a reading and then join us in the Responsibility Pledge.<br></br><br></br>
                   <strong>Optional prayers</strong> 
                    <br></br><br></br>
                    A Vision for You pg. 164<br></br>
